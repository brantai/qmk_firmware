...
|        |        |        |        |        |        |        |        |        |        |        |        |        |        |        |        |        |        |        |
| ESC*   |   F1   |   F2   |   F3   |   F4   |  MRWD  |  MPLY  |  MSTP  |  MFFFD |   F9   |  F10   |  F14   |  F15   |  MUTE  | VOLDWN | VOLUP  |  HOME  |  END   |LCK_SCR |
...
|              |        |        |        |        |        |        |        |        |        |   ;    |   '    |                    |        |        |        |   PG   |
|   TG(1)      |   A    |   S    |   D    |   F    |   G    |   H    |   J    |   K    |   L    |   :    |   "    |       ENTER        |   4    |   5    |   6    |   DN   |
...
*/
	...
	LAYOUT(
    KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_MRWD,   KC_MPLY,   KC_MSTP,   KC_MFFD,   KC_F9,   KC_F10,  KC_F14,  KC_F15,  KC__MUTE, KC__VOLDOWN, KC__VOLUP,  KC_HOME, KC_END, M(LOCK_SCREEN),
    ...
    TG(1), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,                    KC_4,   KC_5,   KC_6,   KC_PGDN,
...
*/
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_DEL, _______, _______, _______,
